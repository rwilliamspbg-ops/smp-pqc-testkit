//! Constant-time check for ML-KEM-768 decapsulation, using the [DudeCT]
...
fn ml_kem_768_decapsulate_valid_vs_corrupted_ciphertext(runner: &mut CtRunner, rng: &mut BenchRng) {
...
ctbench_main!(ml_kem_768_decapsulate_valid_vs_corrupted_ciphertext);
